...
export default function DashboardHome() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-lg font-bold text-neutral-900">Salom, {current.name}!</h1>
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <Card>
          <p className="text-sm text-neutral-500">Sizning rolingiz</p>
          <p className="text-lg font-semibold capitalize">{current.role}</p>
        </Card>
        <Card>
          <p className="text-sm text-neutral-500">Holat</p>
